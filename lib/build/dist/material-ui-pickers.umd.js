(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : factory(
        (global['material-ui-pickers'] = {}),
        global.PropTypes,
        global.React,
        global['material-ui'].Icon,
        global['material-ui'].IconButton,
        global['material-ui'].InputAdornment,
        global['material-ui'].TextField,
        global['material-ui'].Button,
        global['material-ui'].Dialog,
        global['material-ui'].DialogActions,
        global['material-ui'].DialogContent,
        global.styles,
        global['material-ui'].createStyles,
        global['material-ui'].withStyles,
        global['material-ui'].Toolbar,
        global['material-ui'].Typography,
        global.ReactDOM,
        global['material-ui'].Popover,
        global['material-ui'].Paper,
        global['material-ui'].withTheme,
        global['material-ui'].Tab,
        global['material-ui'].Tabs
      );
})(this, function(
  exports,
  PropTypes,
  ...
  IconButton =
    IconButton && IconButton.hasOwnProperty('default') ? IconButton['default'] : IconButton;
  InputAdornment =
    InputAdornment && InputAdornment.hasOwnProperty('default')
      ? InputAdornment['default']
      : InputAdornment;
  ...
  DialogActions =
    DialogActions && DialogActions.hasOwnProperty('default')
      ? DialogActions['default']
      : DialogActions;
  DialogContent =
    DialogContent && DialogContent.hasOwnProperty('default')
      ? DialogContent['default']
      : DialogContent;
  createStyles =
    createStyles && createStyles.hasOwnProperty('default') ? createStyles['default'] : createStyles;
  withStyles =
    withStyles && withStyles.hasOwnProperty('default') ? withStyles['default'] : withStyles;
  Toolbar = Toolbar && Toolbar.hasOwnProperty('default') ? Toolbar['default'] : Toolbar;
  Typography =
    Typography && Typography.hasOwnProperty('default') ? Typography['default'] : Typography;
          ...
          var c = r(11),
            ...
            m = (function(e) {
              function t() {
                ...
                var u = a(
                  this,
                  (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(n))
                );
                return (u.onBlur = u.onBlur.bind(u)), (u.onChange = u.onChange.bind(u)), u;
              }
              return (
                u(t, e),
                s(t, [
        ...
        function(e, t, r) {
          function n() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : s,
              t =
                arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : l.placeholderChar;
            if (!o(e))
              throw new Error(
          ...
          function u(e) {
            for (var t = [], r = void 0; (r = e.indexOf(f)), r !== -1; ) t.push(r), e.splice(r, 1);
              ...
              update: function(r) {
                ...
                if (('undefined' == typeof r && (r = o.value), r !== t.previousConformedValue)) {
                  ...
                  var P = void 0,
                    x = void 0;
                  if (
                    (s instanceof Array && (P = (0, d.convertMaskToPlaceholder)(s, g)), s !== !1)
                  ) {
                    var w = a(r),
                      _ = o.selectionEnd,
                      ...
                      j = void 0;
                    if (('undefined' == typeof s ? 'undefined' : l(s)) === h.strFunction) {
                      if (
                        ((x = s(w, {
    ...
    (function(_super) {
      ...
      function DateTextField() {
        ...
        _this.commitUpdates = function(value) {
          ...
          var error = showError ? getError(newValue, _this.props) : '';
      ...
      (function(_React$PureComponent) {
        ...
        function EventListener() {
          ...
          return _possibleConstructorReturn(
            this,
            _getPrototypeOf(EventListener).apply(this, arguments)
          );
        }
    ...
    return React.createElement(
      ...
      __assign(
        {
          ...
          classes: {
            paper: classnames(
              classes.dialogRoot,
              ((_b = {}), (_b[classes.dialogWithTabs] = showTabs), _b)
            ),
          },
        },
        other
      ...
      React.createElement(DialogContent, {
        ...
        className: classnames(
          classes.dialog,
          ((_c = {}), (_c[classes.dialogWithTabs] = showTabs), _c)
        ),
      }),
      React.createElement(
        DialogActions,
      ...
      (function(_React$Component) {
        ...
        function CSSTransition() {
          ...
          _this.getClassNames = function(type) {
            ...
            var className =
              typeof classNames !== 'string' ? classNames[type] : classNames + '-' + type;
            var activeClassName =
              typeof classNames !== 'string' ? classNames[type + 'Active'] : className + '-active';
            var doneClassName =
              typeof classNames !== 'string' ? classNames[type + 'Done'] : className + '-done';
            return {
              className: className,
        ...
        TransitionGroup.getDerivedStateFromProps = function getDerivedStateFromProps(
          ...
          return {
            children: firstRender
              ? (0, ChildMapping.getInitialChildMapping)(nextProps, handleExited)
              : (0, ChildMapping.getNextChildMapping)(nextProps, prevChildMapping, handleExited),
            firstRender: false,
          };
        };
    ...
    return React.createElement(
      ...
      function(_a) {
        ...
        return React.createElement(
          ...
          React.createElement(ComponentToShow, {
            date: date,
            allowKeyboardControl: allowKeyboardControl,
            animateYearScrolling: animateYearScrolling,
            disableFuture: disableFuture,
  ...
  var ClockNumber =
    ...
    (function(_super) {
      ...
      ClockNumber.prototype.render = function() {
        ...
        var className = classnames(
          classes.clockNumber,
          ((_a = {}), (_a[classes.selected] = selected), _a)
        );
        return React.createElement(
          Typography,
          {
    ...
    (function(_super) {
      ...
      function TimePicker() {
        ...
        _this.handleChange = function(_a) {
          ...
          var withMeridiem = convertToMeridiem(
            time,
            _this.state.meridiemMode,
            Boolean(_this.props.ampm),
            _this.props.utils
          );
        ...
        return React.createElement(
          ...
          React.createElement(
            PickerToolbar$1,
            {
              className: classnames(
                classes.toolbar,
                ((_a = {}), (_a[classes.toolbarLeftPadding] = ampm), _a)
              ),
            },
            React.createElement(
              'div',
  ...
  var DateTimePickerTabs$1 = withTheme()(
    withStyles(styles$g, {
  ...
  var DateTimePicker =
    ...
    (function(_super) {
      ...
      DateTimePicker.prototype.render = function() {
        ...
        var ViewContainerComponentProps =
        ...
        return React.createElement(
          ...
          showTabs &&
            React.createElement(DateTimePickerTabs$1, {
              view: openView,
          ...
          React.createElement(
            Container,
            __assign({}, ViewContainerComponentProps),
            React.createElement(
            ...
            React.createElement(
              ...
              {
                selected:
                  openView === DateTimePickerView$1.HOUR ||
      ...
      DateTimePicker.propTypes = {
        ...
        openTo: PropTypes.oneOf(
          Object.keys(DateTimePickerView$1).map(function(key) {
